...
public class HelpFormatter {
   ...
   public String make0() throws HelpFormatter.HelpFormatException {
      if (this.parts.size() != 4) {
         throw new HelpFormatter.HelpFormatException("You must set all help fields in order to compile help information.");
      } else {
         return "§aDescription: "
   ...
   public static String generateArgs(ProtoParse protoParse) {
      ...
      for (String s : var.keySet()) {
         ...
         List<DoubleVar<String, ProtoParse.ProtoParseData>> list = (List<DoubleVar<String, ProtoParse.ProtoParseData>>)(var1.containsKey(
